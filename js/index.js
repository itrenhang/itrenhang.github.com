window.onload=function(){
   ...
   ;(function(){
	...
	;(function(){
		...
		var aLi = oUl.children;
		var hrefArr=['javascript/point.html','javascript/window.html','javascript/tab.html','javascript/play.html','javascript/list.html','javascript/drag.html']
		var hrefArr2=['html5/clock.html','html5/shake.html','html5/qingxie/demo.html','html5/3dtupian/demo.html','html5/bw.html','html5/daoying/demo.html']
		var imgArr1=['shoufengqin','fenbu','tab','youxi','tuozhuai','gundong'];
		var imgArr2=['shizhong','baichui','jilu','tupianhuan','wuziqi','zoulang'];
		var innerArr=['手风琴','分布运动','无缝滚动选显卡','游戏','拖拽','图片比例缩放'];
		var innerArr2=['时钟','摆锤','仿safari','3D图片环','五子棋','3D倒影走廊'];
		// 布局转换
		var aPos = [];
		for(var i=0;i<aLi.length;i++){
